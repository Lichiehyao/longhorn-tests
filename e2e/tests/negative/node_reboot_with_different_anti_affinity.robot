...
Power Off Node With Anti-Affinity Settings
    [Arguments]    ${disk_affinity}    ${node_affinity}    ${zone_affinity}    ${node_num}    ${power_off_time}    ${description}
...
*** Test Cases ***    DISK-AFFINITY    NODE-AFFINITY    ZONE-AFFINITY    NODE#    POWER-OFF-TIMEZONE    DESCRIPTION
Power Off Replica Node More Than 3 Mins With Different Anti-Affinity Combinations
    false    false    true     1       4      Zone Level Enabled
    false    true     true     1       4      Disk Level Disabled
    true     false    true     1       4      Node Level Disabled
    true     true     true     1       4      All Enabled

Power Off Replica Node Less Than 3 Mins With Different Anti-Affinity Combinations
    false    false    true     1       2      Zone Level Enabled
    false    true     true     1       2      Disk Level Disabled
    true     false    true     1       2      Node Level Disabled
    true     true     true     1       2      All Enabled

Power Off Volume Node More Than 3 Mins With Different Anti-Affinity Combinations
    false    false    true     0       4      Zone Level Enabled
    false    true     true     0       4      Disk Level Disabled
    true     false    true     0       4      Node Level Disabled
    true     true     true     0       4      All Enabled

Power Off Volume Node Less Than 3 Mins With Different Anti-Affinity Combinations
    false    false    true     0       2      Zone Level Enabled
    false    true     true     0       2      Disk Level Disabled
    true     false    true     0       2      Node Level Disabled
    true     true     true     0       2      All Enabled